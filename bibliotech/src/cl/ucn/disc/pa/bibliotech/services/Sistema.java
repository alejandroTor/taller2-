    ...
    public void CalificarLibro() {
        ...
        while (!Objects.equals(opcion, "5")) {
            ...
            StdOut.println("""   
                     ...
                     5 estrellas!
                    """);
            StdOut.print("esccoja cantidad de estrellas ");
            opcion = StdIn.readLine();

            switch (opcion) {
                case "0" -> cantidadEstrellas = 0; //promedioEstrellas = promedioEstrellas + cantidadEstrellas;
                case "1" -> cantidadEstrellas = 1;
                case "2" -> cantidadEstrellas = 2;
                case "3" -> cantidadEstrellas = 3;
                case "4" -> cantidadEstrellas = 4;
                case "5" -> cantidadEstrellas = 5;
            }
        }
        public void
/*
        public boolean validarNumeroDeSocio(){
            for (int i = 0;i <= socios.length;i++){
                if (socios[i].getNumeroDeSocio()==socio.getNumeroDeSocio()){
                    return true;
